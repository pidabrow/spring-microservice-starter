...
class JsonPatchGeneratorTest {
    ...
    void should_return_empty_array_when_objects_are_identical() {
        User user = new User(ID, TENANT_ID, "a@b.com", "+1", "A", "B", new UserPreferences(true, false), null);
    ...
    void should_generate_replace_operation_for_changed_field() {
        User before = new User(ID, TENANT_ID, "old@b.com", "+1", "A", "B", new UserPreferences(true, false), null);
        User after = new User(ID, TENANT_ID, "new@b.com", "+1", "A", "B", new UserPreferences(true, false), null);
    ...
    void should_generate_multiple_operations_for_multiple_changes() {
        User before = new User(ID, TENANT_ID, "old@b.com", "+1", "OldFirst", "OldLast", new UserPreferences(true, false), null);
        User after = new User(ID, TENANT_ID, "new@b.com", "+1", "NewFirst", "OldLast", new UserPreferences(true, false), null);
    ...
    void should_handle_nested_object_changes() {
        User before = new User(ID, TENANT_ID, "a@b.com", "+1", "A", "B", new UserPreferences(true, false), null);
        User after = new User(ID, TENANT_ID, "a@b.com", "+1", "A", "B", new UserPreferences(true, true), null);
